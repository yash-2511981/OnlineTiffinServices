...
<div class="module form-module" style="background-color:#def2f1;box-shadow:7px 7px 40px 3px black;">
  <div class="toggle">
  ...
  <div class="form">
   ...
   <span style="color:green;"><?php echo $success; ?></span>
    <form action="" method="post">
      ...
      <input type="submit" id="buttn" name="submit" value="Login" style="margin-top:30px;background-color:#17252a" />
    </form>
  </div>
  
  <div class="cta" style="background-color:#;">Not registered?<a href="registration.php" style="color:#5c4ac7;"> Create an account</a></div>
</div>
