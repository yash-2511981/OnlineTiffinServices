                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary" style="background-color: transparent;">
                            <div class="card-header"  style="background-color:#2b7a78;box-shadow:4px 4px 15px black;border-radius:45px;">
                                <h4 class="m-b-0 text-white"style="text-align:center;"><b>View Order</b></h4>
                            </div>
                             
                                <div class="table-responsive m-t-20" style="border-radius:10px;box-shadow:4px 4px 15px black;">
                                           ...
                                           <?php
                                            ...
                                            <tr>
                                               <td><center>
												    ...
												    <button type="button" class="btn btn-primary" style="background-color:#17252a; color:white;border-radius:5px;" onmouseover="this.style.backgroundColor='#3aafa9';" onmouseout="this.style.backgroundColor='#17252a';">View User Detials</button></a>											
											   </center>
                                               </td>
                                                <td><center>
											        <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
													<button type="button" class="btn btn-primary" style="background-color:#17252a; color:white;border-radius:5px;" onmouseover="this.style.backgroundColor='#3aafa9';" onmouseout="this.style.backgroundColor='#17252a';">Update Order Status</button></a>
													</center>
											    </td>
                                            </tr>
