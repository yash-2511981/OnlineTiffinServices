...
{		
		...
		if($extension == 'jpg'||$extension == 'png'||$extension == 'gif' )
			...
			if($fsize>=1000000)
				...
				{
				$sql =
                 "update dishes set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";
					mysqli_query($db, $sql); 
...
<body class="fix-header">
 ...
 <div class="scroll-sidebar"  style="background-color: #FAEBD7;">
     <nav class="sidebar-nav" style="background-color: #FAEBD7;">
        ...
        <div class="page-wrapper" style="margin-bottom:75px;background-color: transparent;">
            <div class="container-fluid">
									<?php  echo $error;
									        echo $success; 
                                    ?>
					    <div class="col-lg-12" style="box-shadow:1px 1px 5px black;border-radius:10px;background-color:#def2f1;margin-bottom:75px;">
                        <div class="card card-outline-primary" style="background-color:#def2f1;">
                            <div class="card-header" style="background-color:#2b7a78;box-shadow:4px 4px 15px black;border-radius:25px;margin-bottom:15px;">
                                <h4 class="m-b-0 text-white" style="text-align:center;"><b>Update Menu</b></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" value="<?php echo $roww['title'];?>" class="form-control" placeholder="Morzirella"  style="border-radius:5px;border:1px solid lightblue;">
                                                   </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" value="<?php echo $roww['slogan'];?>" class="form-control form-control-danger" placeholder="slogan"  style="border-radius:5px;border:1px solid lightblue;">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="Rs"  style="border-radius:5px;border:1px solid lightblue;">
                                                   </div>
                                            </div>
